...
export default {
  ...
  methods: {
    ...
    async getCenter(newOptions) {
      ...
      try {
        const response = await adminApi.getOtherServicesType({
          page,
          limit: itemsPerPage,
    ...
    async addCenter() {
      ...
      if (valid) {
        ...
        try {
          const response = await adminApi.addOtherServicesType({
            name: this.data.name,
          });
    ...
    async editItemConform() {
      ...
      if (valid) {
        ...
        try {
          const response = await adminApi.editOtherServicesType({
    ...
    async deleteItemConfirm() {
      ...
      try {
        const response = await adminApi.removeOtherServicesType(
