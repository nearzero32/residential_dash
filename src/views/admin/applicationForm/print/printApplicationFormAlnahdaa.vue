          ...
          <div>
            <div>
              ...
              <p>
                ...
                الموجودة تفاصيلها ادناه واوافق على كافة الفقرات والتعليمات
                والشروط الموجودة في العقد الخاص بشراء الوحدة السكنية وملحقاتها .
              </p>
              ...
              <div>
                ...
                >
                  <p>
                    البلوك :
                    <span
                      style="border-bottom: dashed 1px; margin-left: 60px"
                      >{{ data.form_block_number }}</span
                    >
                  </p>
                ...
                <p>
                  السعر رقمآ :
                  <span style="border-bottom: dashed 1px; margin-left: 60px"
                    >{{ numberWithComma(data.house_info.price) }} دينار
                    عراقي</span
                  >
                  كتابة :
                  <span style="border-bottom: dashed 1px; margin-left: 60px">{{
              ...
              <tbody>
                <tr>
                  <td style="border: 1px solid black; padding: 8px">
                    {{ numberWithComma(data.payment_info.management_fees) }}
                  </td>
                  <td
                    style="
                      text-align: center;
                    ...
                    "
                  >
                    {{ numberWithComma(data.payment_info.first_payment) }}
                  </td>
                  <td
                    style="
                      text-align: center;
        ...
        >
          <div>
            <p>
              ...
              وتفاصيلها وبنود عقد البيع لتملك الوحدة السكنية في
              {{ dataResidential.center_id.name }} وتفاصيلها واتعهد بااللتزام
              بكافة الشروط واتحمل كافة التبعات الماليه والقانونية .<br />
...
export default {
  ...
  created() {
    this.data = JSON.parse(
      localStorage.getItem("printApplicationFormAlnahdaa")
    );
