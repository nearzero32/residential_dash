          ...
          <v-container>
            <div>
              <div>
                ...
                <div>
                  <p>حرر هذا العقد في اليوم المصادف :</p>
                  <p>بين كل من :</p>
                  <p>
                ...
                <div>
                  <v-row>
                    ...
                    <v-col
                      ...
                      style="padding: 3px; border: solid 1px black"
                    >
                    رقم الهوية:{{ data.owner_id_number }}/ تاريخ الاصدار: {{ data.owner_id_issue_date }}
                    </v-col>
                    <v-col
                      cols="6"
                      md="6"
                    ...
                    <v-col
                      ...
                      style="padding: 3px; border: solid 1px black"
                    >
                    رقم بطاقة السكن:{{ data.owner_id_residence_card_number }}/ مكان الاصدار: {{ data.owner_id_residence_card_place_of_issue }} / تاريخ الاصدار :{{ data.owner_id_residence_card_issue_date }}
                    </v-col>
                  </v-row>
                </div>
              </div>
              ...
              <div style="height: 100%;">
                ...
                <div>
                  ...
                  <p>
                    ...
                    العقد بمشروع (مجمع النهضة السكني) حيث ان هذا المجمع يتمتع
