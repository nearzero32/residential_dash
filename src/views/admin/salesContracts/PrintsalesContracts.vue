          ...
          <v-container>
            <div>
              <div style="text-align: center">
                <h2 style="border-block: solid 2px black; margin-inline: 80px">
                  مجمع النهضة السكني
                </h2>
                ...
                <div>
                  <v-row>
                    ...
                    <v-col
                      ...
                      md="6"
                      style="padding: 3px; border: solid 1px black"
                      ><p>رقم هاتف الشركة</p></v-col
                    >
                    <v-col
                      cols="6"
                      md="6"
                      style="padding: 3px; border: solid 1px black"
                      ><p>70047476769</p></v-col
                    >
                    <v-col
                      cols="6"
                      md="6"
                      style="padding: 3px; border: solid 1px black"
                      ><p>البريد الألكتروني</p></v-col
                    >
                    <v-col
                      cols="6"
                      md="6"
                      style="padding: 3px; border: solid 1px black"
                      ><p>sonaaco@yahoo.com</p></v-col
                    >
                  </v-row>
                </div>
                <div>
                  <p>حرر هذا العقد في اليوم المصادف 2024/11/5</p>
                  <p>بين كل من :</p>
                  <p>
                ...
                <div>
                  <v-row>
                    ...
                    <v-col
                      ...
                      style="padding: 3px; border: solid 1px black"
                      ><p>
                        العنوان المختار من قبل الطرف الثاني /المشتري كمحل للتبليغ
                      </p></v-col
                    >
                    <v-col
                      cols="6"
                    ...
                    >
                      <div
                        ...
                        "
                      >
                        <p style="margin-left: 25%">المحافظة :</p>
                        <p>الحي :</p>
                      </div>
                      <div
                        style="
                        ...
                        "
                      >
                        <p style="margin-left: 25%">الدار :</p>
                        <p style="margin-left: 25%">الزقاق :</p>
                        <p>المحلة :</p>
                      </div>
                      <div
                        style="
                    ...
                    <v-col
                      ...
                      md="6"
                      style="padding: 3px; border: solid 1px black"
                      ><p>رقم البطاقة الوطنية وتاريخ الاصدار</p></v-col
                    >
                    <v-col
                      cols="6"
                      md="6"
                    ...
                    <v-col
                      ...
                      style="padding: 3px; border: solid 1px black"
                      ><p>
                        رقم هوية الاحوال المدنية ومكان الاصدار وتاريخ الاصدار رقم
                        شهادة الجنسية ومكان الاصدار وتاريخ الاصدار
                      </p></v-col
                    >
                    <v-col
                      cols="6"
                    ...
                    <v-col
                      ...
                      md="6"
                      style="padding: 3px; border: solid 1px black"
                      ><p>رقم بطاقة السكن ومكان الاصدار وتاريخ الاصدار</p></v-col
                    >
                    <v-col
                      cols="6"
                      md="6"
              ...
              <div>
                ...
                <div>
                  <p>
                    ...
                    العامة محدودة المسؤلية أسست بموجب قانون الشركات العراقية رقم 21
                    لسنة 1997 الواقعة في بغداد اليرموك م/618 ش/3 د/59
                  </p>
                  <p>
                    <strong>العقد:</strong>هو الوثيقة التي توقعها الشركة مع
                    المشتري لأي من الوحدات السكنية الكائنة في هذا المشروع والمعروف
                    هنا باسم ( مجمع النهضة السكني ).
                  </p>
                  <p>
                    <strong>الأجزاء المشتركة:</strong>وتعني هنا على سبيل المثال لا
                    الحصر، الحدائق، المداخل، والكراجات الخ... وهي كافة الاجزاء
                    التي ينتفع منها السكان في هذا المشروع.
                  </p>
                  <p>
                    <strong>موعد التسليم:</strong>هو موعد تسليم الوحدات السكنية
                    للمشتري وفقاً لما يحدده الطرف الاول (البائع) والمثبت بهذا
                    العقد وحسب المتغيرات والاحداث وبما لايؤثر بشكل كبير على الموعد
                    المقرر مع الأخذ بعين الاعتبار الحالات الطارئة.
                  </p>
                  <p>
                    <strong>الوحدة السكنية:</strong>هي الدار الموصوف بهذا العقد
                    وهو عبارة عن دار سكني مثبت برقم بلوك ورقم شارع ورقم دار.
                  </p>
                  <p><strong>الثمن:</strong> المبلغ الكلي للوحدة السكنية.</p>
                  <p>
                    <strong>جدول التسديد: </strong> يقصد به طريقة سداد ثمن الوحدة
                    السكنية والوارد بهذا العقد والذي يبين مواعيد تسديد مبلغ الوحدة
                    السكنية.
                  </p>
                  <p>
                    <strong>الفوائد القانونية: </strong> يقصرد بها الفوائد
                    القانونية المبينة نسبها في هذا العقد نتيجة التأخر والتخلف عن
                    تسديد الدفعات المستحقة بذمة المشتري او التأخر في تسديد الخدمات
                    او أية فوائد قانونية أخرى نصت عليها بنود هذا العقد.
                  </p>
                  <p>
                    <strong> التسجيل: </strong> يقصرد به تسجيل الوحدة السكنية
                    المباعة للمشتري لدى الجهات المختصة وفق القانون العراقي وقانون
                    االستثمار رقم 13 لسنة 2006 وتعديلاته وما تقراه القوانين
                    العراقية.
                  </p>
                  <p>
          ...
          <v-container style="height: 100%;">
            <div class="dis">
              <div style="height: 100%;">
                <div style="text-align: center">
                  <strong style="border-bottom: solid 1px black">تمهيد</strong>
                </div>
                <div>
                  <p>
                    لما كان الطرف الأول (البائع) يعمل في مجال الأستثمارات العقارية
                    وتسويقها وحيث أنه المستثمر والمسوق لمشروع مجمع النهضة السكني
                    في محافظة المثنى-مدينة السماوة بموجب الأجازة الأستثمارية
                    المرقمة 2022/410 والصادرة من هيئة أستثمار المثنى.
                  </p>
                  <p>
                    وبما ان الطرف الأول(البائع) قد طرح بيع الوحدات السكنية للجمهور
                    نقداً وبحسب الدفعات المتفق عليها بين الطرفين والمثبتة في هذا
                    العقد بمشروع (محمع النهضة السكني) حيث ان هذا المجمع يتمتع
                    بطابع حضاري ومعماري متميز ، وبناءاً على ما تم ذكره فقد تقدم
                    الطرف الثاني (المشتري) وابدى رغبته بشراء وحدة سكنية موضوع هذا
                    العقد بالشروط الواردة في هذا العقد، بعد ان اقر الطرفين
                    بأهليتهما بالتعاقد وخلو ارادتها من العيب المبطل فقد اتفقا على
                    ما يلي
                  </p>
                </div>
                <br />
              ...
              <div style="height: 100%;">
                ...
                <div>
                  ...
                  <v-row>
                    ...
                    >
                    <v-col cols="6" md="6"><h4>رقم الوحدة السكنبة:</h4></v-col>
                    <v-col cols="6" md="6" style="padding-inline: 100px"
                      ><h4
                        style="
                          padding-block: 10px;
                    ...
                    >
                    <v-col cols="6" md="6"
                      ><h4>المساحة الشاملة للوحدة السكنية:</h4></v-col
                    >
                    <v-col cols="6" md="6" style="padding-inline: 100px"
                      ><h4
                        style="
                    ...
                    >
                    <v-col cols="6" md="6"
                      ><h4>المساحة الصافية للوحدة السكنية:</h4></v-col
                    >
                    <v-col cols="6" md="6" style="padding-inline: 100px"
                      ><h4
                        style="
                  ...
                  <p>
                    طبقاً لمواصفات التسليم للوحدة السكنية زالمحدد موقعها بالمخطط
            ...
            <div class="dis">
              <div style="height: 100%;">
                ...
                <div>
                  ...
                  <p>
                    1- ابرم هذا العقد ووافرق عليه الطرف الطرفران ببدل كامل قدراه (
                    ) دينار عراقي فقط لا غير للوحدة السكنية المباعة المشار اليها
                    في هذا العقد وحسب طريقة الدفع وجدول التسديد، بواقع ( ) شهر من
                    تاريخ توقيع هذا العقد وبواقع ( ) دفعات كل ( ) اشهر دفعة واحدة
                    وكالتالي.
                  </p>
                  <p>
                    2- طريقة الدفع / يتم التسديد عن طريق ايداع مبلغ الدفعات في
                    حساب الطرف الاول وبموجب ايصاالات دفع(فيشرة ايداع) من المصرف
                    المعروف من قبل الطرف الاول باسم الحسراب ورقمه وكود التسجيل
                    وكالاتي:
                  </p>
              ...
              <div style="height: 100%;">
                ...
                <div>
                  ...
                  <p>
                    ...
                    يقر هنا الطرف الثاني بأنه وافق على شراء الوحدة السكنية موضوع
                    هذا العقد بعد ان اطلع على المخططات والتصاميم العامة للمجمع
                    والخاصة بالردار ومساحته وتسلسلالته وقد عاينها معاينة نافية
                    للجهالة واطلع كذلك على مراحل تقدم العمل وموعد التسليم النهائي،
                    وان الطرف الاول قد عرض بيع الوحردات السكنية ككل بغض النظر عن
                    المساحة الدقيقة لكل نوع من الدور حيث ان المساحات تختلف باختلاف
                    التصاميم من دار لاخر ومن بلوك لاخر وقد اطلع الطرف الثاني على
                    هذه المعلومات بشكل تام ينفي الجهالة وقبل الشراء بدون تحفظ. حتى
                    في حالة ظهور نقصان في مساحة الوحدة السكنية نقصاناً يسيراً لا
                    يؤثر على مساحة الوحدة السكنية واستخداماتها ومساحات اجزاءها
                    المتعددة فلا يحق للطرف الثاني مطالبة الطرف الاول باي تعويضات
                    او يكون سبباً للفسخ كما يقر الطرف الثاني (المشتري) بعلمه
                    بمواصفات التسليم.
                  </p>
                </div>
            ...
            <div class="dis">
              <div style="height: 100%;">
                ...
                <div>
                  <!-- <strong>الاحكام العامة:</strong> -->
                  <p>
                    2- يقر الطرف الثاني (المشتري) بعد توقيع هذا العقد وبصفة نهائية
                    بأن يقتصر انتفاعه بالوحدة السكنية المباعة وملحقاتها على الغرض
                    الذي خصصرت من اجله وهو السكن العائلي فقط بحيث لا يجوز له
                    استخدامها بشكل مخالف للغرض المتفق عليه كما لا يجوز له شطرها
                    مما يؤدي الى زيادة عدد سكان المجمرع ولا يحق له اجراء اي اعمال
                    او أبنية خارجية مثل (تغيير الواجهة او طلائها بلون مخالف) تؤثر
                    بالمظهر الخارجي للدار وعدم القيام بأي بناء او انشاءات او
                    مسقفاق على سطح الدار وممنوع عليه القيام بأعمال تخالف النظام
                    العام والاداب العامة.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    مبلغ وقدره ( ) دينار عراقي كشرط جزائي الى الطرف الاول ( البائع
              ...
              <div style="height: 100%;">
                ...
                <div>
                  ...
                  <p>
                    ...
                    للسكن فيها) خلال الموعد المقرر( ) شهراً من تاريخ هذا العقد.
                  </p>
                  <p>
              ...
              <div style="height: 100%;">
                ...
                <div>
                  ...
                  <p>
                    ...
                    مضافة على التوقيتات الخاصة بمدة الانجازي.
                  </p>
                  <p>
            ...
            <div class="dis">
              <div style="height: 100%;">
                ...
                <div>
                  ...
                  <p>
                    1- لا تنتقل ملكية الوحدة السكنية الا بعد قيام الطرف الثاني
                    بتسديد كامل المبالغ والدفعات التي بذمته لصالح الطرف الاول وحسب
                    ما مذكور في جدول الدفعت في هذا العقد على ان ات تكون الوحدة
                    السكنية موضوع هذا العقد محجوزة او مرهونة الى اي جهة اخرى.
                  </p>
                  <p>
                    2- يلتزم ويتعهد الطرف الثاني بتسديد مبلغ الوحدة السكنية المثبت
                    في هذا العقد بحسب جدول الدفعات خلال خمسة عشر يوماً من تاريخ
                    استحقاق الدفعة المقررة وبخلافه يقر الطرف الثاني ويلتزم ويتعهد
                    بتأدية وتسديد مبلغ 100,000 دينار (مائة الف دينار عراقي) عن كل
                    يوم تأخير على ان لا تتجاوز هذاه الغرامات مدة ستون يوم من تاريخ
                    استحقاقها وبخلافه اقر ووافق الطرف الثاني على اللجوء والأخذ
                    بالفقرة الثالثة ادنى من المادة الخامسة من هذا العقد (انتقال
                    الملكية) .
                  </p>
                  <p>
                    3- يعد هذا العقد باطلاً وال يترتب عليه اي اثر قانوني بعد مرور
                    ستون يوماً من تاريخ استحقاق الدفعة المالية وعدم تسديدها ويعترف
                    ويقر ويلتزم الطرف الثاني لصالح الطرف الاول بالموافقة ويخوله
                    ويتنازل عن كافة الحقوق لصالح الطرف الاول لغرض بيع العقار موضوع
                    هذا العقد واعادة المبلغ الى الطرف الثاني بالسعر المذكور
                    والمثبات في هذا العقد بعد خصم المصاريف الادارية والقانونية
                    والغرامات التأخيرية وعمولات البيع و الشرط الجزائي .
                  </p>
                  <p>
                    4-	يلتزم الطرف الثاني في حال رغبته بالتنازل عن العقار أو بيعه،  بتنفيذ عملية البيع ضمن قسم العقود (وحسب ما جاء في المصطلحات والتعاريف في هذا العقد) على ان لا تكون الوحدة السكنية مقيدة باي التزام مالي او قانوني على الوحدة السكنية موضوع هذا العقد ويتعهد الطرف الثاني بتسديد  مبلغ مقطوع الى قسم العقود ضمن اعمال الطرف الاول وبواقع 2,000,000 دينار    (مليونين دينار عراقي) ، وللطرفين المتعاقدين في هذه الحالة تنتهي وتنقضي علاقة قسم العقود بعملية البيع والشراء ولا علاقه بالقسم او ادارة المجمع بإجراءات التسجيل في دائرة التسجيل العقاري ودوائر الاخرى ذات العلاقة .                </p>
                </div>
              </div>
              <v-row>
                <v-col
              ...
              <div style="height: 100%;">
                ...
                <div>
                  ...
                  <p>
                    ...
                    والوثائق الرسمية اللازمة لإتمام التسجيل وبخلافه يتحمل الطرف
                    الثاني كافة التبعت القانونية كما يلتزم الطرف الثاني بالعمل مع
                    اللجنة المختصة العائدة للطرف الاول بالتسجيل العقاري والتي تقوم
                    بالتنسيق مع دائرة التسجيل العقاري لنقل وتسجيل ملكية الوحدة
                    السكنية باسم الطرف الثاني (المشتري الاول) على ان يكون الطرف
                    الثاني مسدداً لكامل ثمن الوحدة السكنية وملحقاتها ولكافة
                    المستحقات المالية والغرامات الناتجة عن هذا العقد. <br />
                    وكما يلتزم الطرف الثاني بدفع كافة الرسوم والمصاريف التي تتعلق
                    بنقل الملكية دو مطالبة الطرف الاول بأي تعويض عن تلك الرسوم
                    والمصاريف وحسب القوانين المعمول بها في جمهورية العراق .
                  </p>
                </div>
              </div>
              <v-row>
            ...
            <div class="dis">
              <div style="height: 100%;">
                ...
                <div>
                  ...
                  <p>
                    نظراً لضرورة وجود وسيلة اتصال قانونية قائمة ومعترف بها
                    قانونياً بين طرفين العقد فإن كل من طرفي هذا العقد يقر بصحة
                    العناوين الخاصة به والمبين في هذا العقد وباتخاذ هذا العنوان
                    محلاً مختاراً للتبليغات له ويلتزم باخطار الطرف الأخر في حال
                    تغييره باشعار موصى عليه بعلم الوصول والا اعتبرت جميع الاعلانات
                    والتبليغات المرسله التي تتم عليه صحيحة ومنتجة لكافة اثارها
                    القانونية وتعتبر رسائل البريد الألكتروني بين الطرفين
                    المتعاقدين والرسائل النصية على ارقام الهواتف المحمولة المثبتة
                    في هذا العقد للطرف الثاني وسيلة رسمية وقانونية للتواصل
                    والمخاطبات والتبليغات.
                  </p>
                </div>
              </div>
              <v-row>
            ...
            <div class="dis">
              <div style="height: 100%;">
                ...
                <div>
                  ...
                  <p>
                    1-حرر هذا العقد من طرفيه وبعد الاطلاع عليه وتدقيقه وقبول
                    محتواه واقرار ما جاء فيه وقبول الطرفين به.
                  </p>
                  <p>
                    2- في حال حصول اي خلاف بين الطرفين يتم تسوية الامر من خلال
                    التفاهم بين الطرفين بالطرق الودية وبخلاف ذلك يتم اللجوء الى
                    القضاء.
                  </p>
                  <p>
                    3- تكون محاكم المثنى هي المختصة بالنظر في الخلافات الناتجة من
                    جراء تنفيذ هذا العقد.
                  </p>
                  <p>
                  4- في حال صدور اي تعليمات او تعديلات من الهيئة الوطنية للاستثمار او هيئة استثمار المثنى او الدائر الرسمية الاخرى المختصة ذات العلاقة فانها تسري على الطرفين المتعاقدين.
                  </p>
                  <p>
                  4- في حال صدور اي تعليمات او تعديلات من الهيئة الوطنية للاستثمار او هيئة استثمار المثنى او الدائر الرسمية الاخرى المختصة ذات العلاقة فانها تسري على الطرفين المتعاقدين.
                  </p>
            ...
            <div class="dis">
              <div style="height: 100%;">
                ...
                <div>
                  ...
                  <p>
                    كما يلتزم ويقر الطرف الثاني بدفع مبلغ الاشتراك الشهري الى الطرف الاول والبالغ (    ) دينار عراقي شهريا  ويوافق الطرف الثاني على ذلك المبلغ والذي يدفع كخدمات شهرية في بداية كل شهر مع ملاحظة التفصيل التالي:-
                  </p>
                  <p>
        ...
        >
          ...
          <v-container>
            <div>
              <div style="text-align: center">
                <strong style="border-bottom: solid 1px black"
                  >نسخ العقد والمواد والملاحق</strong
                >
              </div>
              <div>
