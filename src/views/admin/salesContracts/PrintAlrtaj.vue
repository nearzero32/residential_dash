          ...
          <v-container>
            <div>
              <p>
                ...
                اجمالي قدرة ({{ $func(data.salary_amount) }}) علما ان مساحة
                الوحدة السكنية ( الدار) هي ({{ data.house_total_space }} متر
                مربع) .
              </p>
              <p>
          ...
          <v-container>
            <div>
              <p>
                ...
                الوحدة السكنية (الدار) ({{ $func(data.salary_amount) }})دينار
                عراقي واصل منها الدفعة المقدمة والبالغة ({{
            ...
            >
              ...
              >
                ...
                <h3>
                  شركة حول الخليج للتجارة العامة والاستثمارات العقارية /ويمثلها /السيد محمد عليان حسين/المدير المفوض
                </h3>
                <br>
                <h3>التوقيع:</h3>
                <h3>تاريخ :</h3>
