  ...
  methods: {
    ...
    async addCenter() {
      ...
      if (valid) {
        ...
        try {
          const response = await adminApi.addMachines({
            name: this.data.name,
          });
    ...
    async editItemConform() {
      ...
      if (valid) {
        ...
        try {
          const response = await adminApi.editMachines({
    ...
    async deleteItemConfirm() {
      ...
      try {
        const response = await adminApi.removeMachines(
