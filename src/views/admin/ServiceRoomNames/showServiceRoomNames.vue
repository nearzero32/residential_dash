  ...
  methods: {
    ...
    async addCenter() {
      ...
      if (valid) {
        ...
        try {
          const response = await adminApi.addServiceRoomNames({
            name: this.data.name,
          });
    ...
    async editItemConform() {
      ...
      if (valid) {
        ...
        try {
          const response = await adminApi.editServiceRoomNames({
    ...
    async deleteItemConfirm() {
      ...
      try {
        const response = await adminApi.removeServiceRoomNames(
