          ...
          <VContainer>
            <VForm ref="form">
              <VRow>
                ...
                <VCol cols="12" md="12">
                  <VBtn @click="addAnotherOwner" v-if="!AnotherOwner"
                    >{{ t("Add Another Owner") }}
                  </VBtn>
                  <VBtn @click="addAnotherOwner" v-else>{{ t("Cancel") }}</VBtn>
                </VCol>
                <hr style="width: 100%" />
                <VCol cols="12" md="12" v-if="AnotherOwner">
                  <VRow>
                    <VCol cols="12" md="4">
                      <VTextField
                        v-model="data.another_owner.name"
                        :rules="Rules.name"
                        :label="t(`Owner's name`)"
                        outlined
                      />
                    ...
                    <VCol cols="12" md="4">
                      <VTextField
                        v-model="data.another_owner.phone"
                        :rules="Rules.phone"
                        :label="t(`Owner's phone number`)"
                        outlined
                      />
                    ...
                    <VCol cols="12" md="4">
                      <VTextField
                        v-model="data.another_owner.address"
                        :rules="Rules.address"
                        :label="t('Address')"
                        outlined
                      />
                    ...
                    <VCol cols="12" md="4">
                      <VTextField
                        v-model="data.another_owner.id_number"
                        :rules="Rules.id_number"
                        :label="t('National Identification Number')"
                        outlined
                      />
                    ...
                    <VCol cols="12" md="4">
                      <VTextField
                        v-model="data.another_owner.id_place_of_issue"
                        :rules="Rules.id_place_of_issue"
                        :label="
                    ...
                    <VCol cols="12" md="4">
                      <VTextField
                        v-model="data.another_owner.residence_card_number"
                        :rules="Rules.residence_card_number"
                        :label="t('Residence Card Number')"
                        outlined
                      />
                    ...
                    <VCol cols="12" md="6">
                      <VTextField
                        v-model="data.another_owner.owner_title_jop"
                        :rules="Rules.owner_title_jop"
                        :label="t('Job Title')"
                        outlined
                      />
                      ...
                      <VRow>
                        <VCol cols="12" md="6">
                          <VFileInput
                            ...
                            accept="image/png, image/jpeg, image/bmp"
                            prepend-icon="mdi-camera-outline"
                            @change="handleFileChangeIDOTow"
                            @click:clear="
                              file = null;
                              data.another_owner.id_img_front = null;
                            "
                          />
                        </VCol>
                        <VCol cols="12" md="6">
                          <img
                            ...
                            style="width: 130px"
                            :src="
                              isBase64(data.another_owner.id_img_front)
                                ? data.another_owner.id_img_front
                                : content_url + data.another_owner.id_img_front
                            "
                            alt=""
                            @click.stop
                          />
                      ...
                      <VRow>
                        <VCol cols="12" md="6">
                          <VFileInput
                            ...
                            accept="image/png, image/jpeg, image/bmp"
                            prepend-icon="mdi-camera-outline"
                            @change="handleFileChangeIDTTow"
                            @click:clear="
                              file = null;
                              data.another_owner.id_img_back = null;
                            "
                          />
                        </VCol>
                        <VCol cols="12" md="6">
                          <img
                            ...
                            style="width: 130px"
                            :src="
                              isBase64(data.another_owner.id_img_back)
                                ? data.another_owner.id_img_back
                                : content_url + data.another_owner.id_img_back
                            "
                            alt=""
                            @click.stop
                          />
                      ...
                      <VRow>
                        <VCol cols="12" md="6">
                          <VFileInput
                            ...
                            accept="image/png, image/jpeg, image/bmp"
                            prepend-icon="mdi-camera-outline"
                            @change="handleFileChangeLTow"
                            @click:clear="
                              file = null;
                              data.another_owner.location_img_front = null;
                            "
                          />
                        </VCol>
                        <VCol cols="12" md="6">
                          <img
                            ...
                            style="width: 130px"
                            :src="
                              isBase64(data.another_owner.location_img_front)
                                ? data.another_owner.location_img_front
                                : content_url +
                                  data.another_owner.location_img_front
                            "
                            alt=""
                      ...
                      <VRow>
                        <VCol cols="12" md="6">
                          <VFileInput
                            ...
                            accept="image/png, image/jpeg, image/bmp"
                            prepend-icon="mdi-camera-outline"
                            @change="handleFileChangeLTTow"
                            @click:clear="
                              file = null;
                              data.another_owner.location_img_back = null;
                            "
                          />
                        </VCol>
                        <VCol cols="12" md="6">
                          <img
                            ...
                            style="width: 130px"
                            :src="
                              isBase64(data.another_owner.location_img_back)
                                ? data.another_owner.location_img_back
                                : content_url +
                                  data.another_owner.location_img_back
                            "
                            alt=""
                      ...
                      <VRow>
                        <VCol cols="12" md="6">
                          <VFileInput
                            ...
                            accept="image/png, image/jpeg, image/bmp"
                            prepend-icon="mdi-camera-outline"
                            @change="handleFileChangePTow"
                            @click:clear="
                              file = null;
                              data.another_owner.passport_img = null;
                            "
                          />
                        </VCol>
                        <VCol cols="12" md="6">
                          <img
                            v-if="data.another_owner.passport_img"
                            style="width: 130px"
                            :src="
                              isBase64(data.another_owner.passport_img)
                                ? data.another_owner.passport_img
                                : content_url + data.another_owner.passport_img
                            "
                            alt=""
                            @click.stop
                          />
          ...
          <VContainer>
            <VForm ref="form">
              <VRow>
                ...
                <VCol cols="12" md="12">
                  <VBtn
                    @click="addAnotherOwnerE"
                    v-if="
                      !AnotherOwnerE ||
                      dialogEdit.editedItem.another_owner.name !== null
                    "
                    >{{ t("Add Another Owner") }}
                  </VBtn>
                  <VBtn @click="addAnotherOwnerE" v-else>{{
                    t("Cancel")
                  }}</VBtn>
                </VCol>
                <hr style="width: 100%" />
                ...
                >
                  <VRow>
                    <VCol cols="12" md="4">
                      <VTextField
                        v-model="dialogEdit.editedItem.another_owner.name"
                        :rules="Rules.name"
                        :label="t(`Owner's name`)"
                        outlined
                      />
                    ...
                    <VCol cols="12" md="4">
                      <VTextField
                        v-model="dialogEdit.editedItem.another_owner.phone"
                        :rules="Rules.phone"
                        :label="t(`Owner's phone number`)"
                        outlined
                      />
                    ...
                    <VCol cols="12" md="4">
                      <VTextField
                        v-model="dialogEdit.editedItem.another_owner.address"
                        :rules="Rules.address"
                        :label="t('Address')"
                        outlined
                      />
                    ...
                    <VCol cols="12" md="4">
                      <VTextField
                        v-model="dialogEdit.editedItem.another_owner.id_number"
                        :rules="Rules.id_number"
                        :label="t('National Identification Number')"
                        outlined
                      />
                    ...
                    <VCol cols="12" md="4">
                      <VTextField
                        v-model="
                          dialogEdit.editedItem.another_owner.id_place_of_issue
                        "
                        :rules="Rules.id_place_of_issue"
                        :label="
                          t('Issuing Authority of the Identification Card')
                    ...
                    <VCol cols="12" md="6">
                      <VTextField
                        v-model="
                          dialogEdit.editedItem.another_owner.owner_title_jop
                        "
                        :rules="Rules.owner_title_jop"
                        :label="t('Job Title')"
                        outlined
                      ...
                      <VRow>
                        <VCol cols="12" md="6">
                          <VFileInput
                            ...
                            accept="image/png, image/jpeg, image/bmp"
                            prepend-icon="mdi-camera-outline"
                            @change="handleFileChangeIDOTowEdit"
                            @click:clear="
                              file = null;
                              dialogEdit.editedItem.another_owner.id_img_front =
                                null;
                            "
                          />
                        </VCol>
                      ...
                      <VRow>
                        <VCol cols="12" md="6">
                          <VFileInput
                            ...
                            accept="image/png, image/jpeg, image/bmp"
                            prepend-icon="mdi-camera-outline"
                            @change="handleFileChangeIDTTowEdit"
                            @click:clear="
                              file = null;
                              dialogEdit.editedItem.another_owner.id_img_back =
                                null;
                            "
                          />
                        </VCol>
                      ...
                      <VRow>
                        <VCol cols="12" md="6">
                          <VFileInput
                            ...
                            accept="image/png, image/jpeg, image/bmp"
                            prepend-icon="mdi-camera-outline"
                            @change="handleFileChangeLTowEdit"
                            @click:clear="
                              file = null;
                              dialogEdit.editedItem.another_owner.location_img_front =
                                null;
                            "
                          />
                        </VCol>
                      ...
                      <VRow>
                        <VCol cols="12" md="6">
                          <VFileInput
                            ...
                            accept="image/png, image/jpeg, image/bmp"
                            prepend-icon="mdi-camera-outline"
                            @change="handleFileChangeLTTowEdit"
                            @click:clear="
                              file = null;
                              dialogEdit.editedItem.another_owner.location_img_back =
                                null;
                            "
                          />
                        </VCol>
                      ...
                      <VRow>
                        <VCol cols="12" md="6">
                          <VFileInput
                            ...
                            accept="image/png, image/jpeg, image/bmp"
                            prepend-icon="mdi-camera-outline"
                            @change="handleFileChangePTowEdit"
                            @click:clear="
                              file = null;
                              dialogEdit.editedItem.another_owner.passport_img =
                                null;
                            "
                          />
                        </VCol>
...
export default {
  ...
  methods: {
    ...
    handleFileChangeIDOTow(event) {
      const file = event.target.files[0];
      if (file) {
        const reader = new FileReader();
        reader.onload = () => {
          this.data.another_owner.id_img_front = reader.result;
        };
        reader.readAsDataURL(file);
      }
    },
    handleFileChangeIDTTow(event) {
      const file = event.target.files[0];
      if (file) {
        const reader = new FileReader();
        reader.onload = () => {
          this.data.another_owner.id_img_back = reader.result;
        };
        reader.readAsDataURL(file);
      }
    },
    handleFileChangeLTow(event) {
      const file = event.target.files[0];
      if (file) {
        const reader = new FileReader();
        reader.onload = () => {
          this.data.another_owner.location_img_front = reader.result;
        };
        reader.readAsDataURL(file);
      }
    },
    handleFileChangeLTTow(event) {
      const file = event.target.files[0];
      if (file) {
        const reader = new FileReader();
        reader.onload = () => {
          this.data.another_owner.location_img_back = reader.result;
        };
        reader.readAsDataURL(file);
      }
    },
    handleFileChangePTow(event) {
      const file = event.target.files[0];
      if (file) {
        const reader = new FileReader();
        reader.onload = () => {
          this.data.another_owner.passport_img = reader.result;
        };
        reader.readAsDataURL(file);
      }
    },
    addAnotherOwner() {
      this.AnotherOwner = !this.AnotherOwner;
      if (!this.AnotherOwner) {
        this.data.another_owner.name = null;
        this.data.another_owner.id_number = null;
        this.data.another_owner.phone = null;
        this.data.another_owner.id_place_of_issue = null;
        this.data.another_owner.id_issue_date = null;
        this.data.another_owner.residence_card_number = null;
        this.data.another_owner.residence_card_place_of_issue = null;
        this.data.another_owner.residence_card_issue_date = null;
        this.data.another_owner.address = null;
        this.data.another_owner.owner_title_jop = null;
        this.data.another_owner.id_img_front = null;
        this.data.another_owner.id_img_back = null;
    ...
    handleFileChangeIDOTowEdit(event) {
      const file = event.target.files[0];
      if (file) {
        const reader = new FileReader();
        reader.onload = () => {
          this.dialogEdit.editedItem.another_owner.id_img_front = reader.result;
        };
        reader.readAsDataURL(file);
      }
    },
    handleFileChangeIDTTowEdit(event) {
      const file = event.target.files[0];
      if (file) {
        const reader = new FileReader();
        reader.onload = () => {
          this.dialogEdit.editedItem.another_owner.id_img_back = reader.result;
        };
        reader.readAsDataURL(file);
      }
    },
    handleFileChangeLTowEdit(event) {
      const file = event.target.files[0];
      if (file) {
        const reader = new FileReader();
        reader.onload = () => {
          this.dialogEdit.editedItem.another_owner.location_img_front =
            reader.result;
        };
        reader.readAsDataURL(file);
      }
    },
    handleFileChangeLTTowEdit(event) {
      const file = event.target.files[0];
      if (file) {
        const reader = new FileReader();
        reader.onload = () => {
          this.dialogEdit.editedItem.another_owner.location_img_back =
            reader.result;
        };
        reader.readAsDataURL(file);
      }
    },
    handleFileChangePTowEdit(event) {
      const file = event.target.files[0];
      if (file) {
        const reader = new FileReader();
        reader.onload = () => {
          this.dialogEdit.editedItem.another_owner.passport_img = reader.result;
        };
        reader.readAsDataURL(file);
      }
    },
      ...
      if (valid) {
        ...
        try {
          const response = await adminApi.addOwners({
            ...
            another_owner: this.data.another_owner,
          });
          if (this.AnotherOwner == true) {
            this.AnotherOwner = false;
          }
      ...
      if (valid) {
        ...
        try {
          const response = await adminApi.editOwners({
            ...
            another_owner: this.dialogEdit.editedItem.another_owner,
          });
